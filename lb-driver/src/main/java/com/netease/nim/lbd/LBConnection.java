...
public class LBConnection implements Connection {
    ...
    protected void checkStatus() throws SQLException {
        ...
        if (isBroken) {
            if (fatalException != null) {
                if (fatalException.getMessage() != null) {
                    throw new SQLException("No operations allowed after connection broken by fatal error. error = " + fatalException.getMessage(), fatalException.getSQLState());
                } else {
                    throw new SQLException("No operations allowed after connection broken by fatal error.", fatalException.getSQLState());
                }
            }
            throw new SQLException("No operations allowed after connection broken by fatal error.", "08003", 0);
        }
    }
    ...
    public void close() throws SQLException {
        ...
        try {
            ...
            if (sqlEx != null && realConnection != null) {
                realConnection.markUnhealthy();
            }
            setTransactionBegun(false);
